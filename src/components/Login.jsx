      ...
      <div className="container">
        <div className="d-flex justify-content-center align-items-center min-vh-100 py-4">
          <div className="card login-card p-4 p-md-5 text-dark border-0">
            ...
            <span className="login-forgot d-flex justify-content-end mb-3" onClick={() => navigate("/password-reset", { state: { role } })}>
              Forgot password?
            </span>

            <div className="d-grid">
              {Loading ? (
               <button className="btn btn-dark login-btn login-loading-btn" type="button" disabled>
