...
function StudentDashboard() {
  ...
  const {classOptions, notifications} = useAppContext();
  ...
  const overallAttendanceSummary = useMemo(() => {
    ...
    const overallPercent =
      total > 0 ? Math.round((totals.present / total) * 100) : 0;
  ...
  const quickAccessItems = useMemo(
    () => [
      ...
      {
        label: "Add Teacher Feedback",
        icon: "fas fa-comment-dots",
        href: "/student/reviews",
      },
       {
        label: "View Test & Syllabus",
        icon: "fas fa-file-alt",
        href: "/viewTestAndSyllabus",
      },
    ],
    [],
  );
        ...
        <div className="dashboard-modal-backdrop password-reset-warning-backdrop">
          <div className="dashboard-modal-card password-reset-warning-card">
            ...
            <button
              ...
              onClick={() =>
                navigate("/password-reset", { state: { role: "Student" } })
              }
            >
                    ...
                    <>
                      ...
                      <div className="student-identity-meta">
                        ...
                        <span className="d-none d-sm-inline">
                          ...
                          {classOptions.find((cls) => cls._id === student?.classInfo)?.name || "-"}
                        </span>
                      </div>
                    </>
                  )}
  ...
  {(showAllMenuItems ? quickAccessItems : quickAccessItems.slice(0, 9)).map(
    (item) => {
                  ...
                  >
                    <div className="chart-panel overview-donut-card h-100">
                      ...
                      <div className="chart-canvas-wrap">
                        <div
                          className="chart-canvas-box chart-canvas-box--overview"
                          style={{ position: "relative" }}
                        >
                          <Doughnut
                          ...
                          >
                            ...
                            >
                              {overallAttendanceSummary.overallPercent}%
                            </div>
                            <div
                              style={{
                                fontSize: "10px",
                        ...
                        <div className="chart-hint-row mt-2">
                          <span className="chart-hint-item">
                            ...
                            Present ({overallAttendanceSummary.present})
                          </span>
                          <span className="chart-hint-item">
                            <span className="chart-hint-dot absent"></span>
                            Absent ({overallAttendanceSummary.absent})
                          </span>
                        </div>
                      </div>
                    </div>
                          ...
                          <div
                            ...
                            style={{
                              background: `conic-gradient(${
                                resultProgressSummary.overallPercent > 90
                                  ? "#22c55e"
                                  : resultProgressSummary.overallPercent > 80
                                    ? CHART_COLORS.average
                                    : CHART_COLORS.improve
                              } 0% ${resultProgressSummary.overallPercent}%, #e2e8f0 ${resultProgressSummary.overallPercent}% 100%)`,
                            }}
                          >
